...
export default function AdminTicketList() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md">
          ...
          <h3 className="text-red-800 font-semibold text-center mb-2">Error Loading Tickets</h3>
  ...
  const totalRevenue = tickets.reduce((sum, ticket) => sum + (ticket.totalCost || 0), 0);
  const totalTicketsSold = tickets.reduce((sum, ticket) => sum + (ticket.numTickets || 0), 0);
          ...
          {tickets.length > 0 && (
            <div className="border-t pt-4 grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-2xl font-bold text-blue-600">{totalTicketsSold}</div>
              </div>
              <div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="text-center py-3 px-6 text-sm font-semibold text-gray-700">Number of Tickets</th>
                    <th className="text-right py-3 px-6 text-sm font-semibold text-gray-700">Total Cost</th>
